...
@Component({
  ...
  styles: [`
    ...
    .auth-title { text-align: center; font-size: 2rem; color: #1a1a2e; margin: 0 0 4px; }
    .auth-subtitle { text-align: center; color: #888; margin: 0 0 32px; font-size: 0.95rem; }
    .form-group { margin-bottom: 20px; }
    label { display: block; margin-bottom: 6px; font-weight: 500; color: #333; font-size: 0.9rem; }
    input { width: 100%; padding: 12px 16px; border: 2px solid #e0e0e0; border-radius: 10px; font-size: 1rem; transition: border-color 0.2s; box-sizing: border-box; }
    ...
    .error-msg { background: #ffeef0; color: #d32f2f; padding: 12px 16px; border-radius: 8px; margin-bottom: 20px; font-size: 0.9rem; }
    .auth-link { text-align: center; margin-top: 24px; color: #888; font-size: 0.9rem; }
